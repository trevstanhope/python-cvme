...
if __name__ == '__main__':
    ...
    try:
        SURF_THRESHOLD = int(sys.argv[1])
        ORB_THRESHOLD = int(sys.argv[2])
        SIFT_THRESHOLD = int(sys.argv[3])
    except:
        print "usage: python -m tests.compare SURF_THRESHOLD, ORB_THRESHOLD, SIFT_THRESHOLD"
        exit(1)
